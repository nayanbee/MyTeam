...
type Cover={id:string,status:string,ownerId:string,owner:string,managerId:string,note:string,urgent:boolean,classes:CoverClass[],invitations:Entry[],applications:Entry[]};
